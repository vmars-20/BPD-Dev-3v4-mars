...
**BPD Deployment Architecture:** See [Obsidian/Project/BPD-Two-Tool-Architecture.md](BPD-Two-Tool-Architecture.md) for complete two-tool deployment + operation architecture (moku-go.py + bpd-debug.py).
